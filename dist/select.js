...
module.exports = "<ul class=\"ui-select-choices ui-select-choices-content list-unstyled\"> <li class=\"ui-select-choices-group\" id=\"ui-select-choices-{{ $select.generatedId }}\"> <div class=\"divider\" ng-show=\"$select.isGrouped && $index > 0\"></div> <div ng-show=\"$select.isGrouped\" class=\"ui-select-choices-group-label dropdown-header\" ng-bind=\"$group.name\"></div> <div ng-attr-id=\"ui-select-choices-row-{{ $select.generatedId }}-{{$index}}\" class=\"ui-select-choices-row dropdown-item\" ng-class=\"{active: $select.isActive(this), disabled: $select.isDisabled(this)}\" role=\"option\"> <span class=\"ui-select-choices-row-inner\"></span> </div> </li> </ul> ";
...
module.exports = "<span class=\"ui-select-match d-flex align-items-center flex-wrap\"> <span ng-repeat=\"$item in $select.selected track by $index\" class=\"d-flex align-items-center p-1\"> <button class=\"ui-select-match-item btn btn-secondary btn-sm text-nowrap d-flex align-items-center text-truncate\" tabindex=\"-1\" type=\"button\" ng-disabled=\"$select.disabled\" ng-click=\"$selectMultiple.activeMatchIndex = $index; $select.toggle($event)\" ng-class=\"{'btn-primary':$selectMultiple.activeMatchIndex === $index, 'select-locked':$select.isLocked(this, $index)}\" ui-select-sort=\"$select.selected\"> <span uis-transclude-append></span> <span class=\"ui-select-match-close ml-1\" ng-hide=\"$select.disabled\" ng-click=\"$selectMultiple.removeChoice($index);$event.stopPropagation();\"> &times;</span> </button> </span> </span>";

/***/ }),
/* 16 */
/***/ (function(module, exports) {

module.exports = "<div class=\"ui-select-match d-flex align-items-center\" ng-hide=\"$select.open && $select.searchEnabled\" ng-disabled=\"$select.disabled\" ng-class=\"{'btn-default-focus':$select.focus}\"> <span tabindex=\"-1\" class=\"form-control ui-select-toggle d-flex\" ng-class=\"{'form-control-sm': $select.size === 'sm', 'form-control-lg': $select.size === 'lg'}\" aria-label=\"{{ $select.baseTitle }} activate\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activate()\" style=\"outline:0\"> <span ng-show=\"$select.isEmpty()\" class=\"ui-select-placeholder text-muted text-truncate flex-fill\">{{$select.placeholder}}</span> <span ng-hide=\"$select.isEmpty()\" class=\"ui-select-match-text flex-fill\" ng-class=\"{'ui-select-allow-clear': $select.allowClear && !$select.isEmpty()}\" ng-transclude=\"\"></span> <i class=\"caret dropdown-toggle\" ng-click=\"$select.toggle($event)\"></i> <a ng-show=\"$select.allowClear && !$select.isEmpty() && ($select.disabled !== true)\" aria-label=\"{{ $select.baseTitle }} clear\" style=\"margin-right:10px\" ng-click=\"$select.clear($event)\" class=\"btn btn-sm btn-link pull-right\"> <i class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></i> </a> </span> </div> ";
...
module.exports = "<div class=\"ui-select-container ui-select-multiple ui-select-bootstrap4 dropdown form-control d-flex align-items-center h-auto\" ng-class=\"{open: $select.open}\"> <div class=\"ui-select-values-container d-flex flex-wrap flex-fill\" ng-click=\"$select.toggle($event)\"> <div class=\"ui-select-match\"></div> <span ng-show=\"$select.open && $select.refreshing && $select.spinnerEnabled\" class=\"ui-select-refreshing {{$select.spinnerClass}}\"></span> <input type=\"search\" autocomplete=\"off\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" class=\"ui-select-search bg-transparent w-auto border-0\" placeholder=\"{{$select.getPlaceholder()}}\" ng-disabled=\"$select.disabled\" ng-model=\"$select.search\" role=\"combobox\" aria-expanded=\"{{$select.open}}\" aria-label=\"{{$select.baseTitle}}\" ng-class=\"{'spinner': $select.refreshing}\" data-disallow-drop=\"data-disallow-drop\"> <div class=\"ui-select-no-choice\"></div> </div> <div class=\"ui-select-indicators ml-2\"> <i class=\"caret dropdown-toggle\" ng-click=\"$select.toggle($event)\"></i> </div> <div ng-class=\"{show : $select.open && $select.items.length > 0}\" class=\"ui-select-dropdown dropdown-menu w-100\"> <div class=\"ui-select-header\"></div> <div class=\"ui-select-choices\"></div> <div class=\"ui-select-footer\"></div> </div> </div>";

/***/ }),
/* 19 */
/***/ (function(module, exports) {

module.exports = "<div class=\"ui-select-container ui-select-bootstrap4 dropdown d-flex flex-column\" ng-class=\"{open: $select.open}\"> <div class=\"ui-select-match d-flex align-items-center\"></div> <span ng-show=\"$select.open && $select.refreshing && $select.spinnerEnabled\" class=\"ui-select-refreshing {{$select.spinnerClass}}\"></span> <input type=\"search\" autocomplete=\"off\" tabindex=\"-1\" aria-expanded=\"true\" aria-label=\"{{ $select.baseTitle }}\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" class=\"form-control ui-select-search\" ng-class=\"{ 'ui-select-search-hidden' : !$select.searchEnabled, 'form-control-sm': $select.size === 'sm', 'form-control-lg': $select.size === 'lg' }\" placeholder=\"{{$select.placeholder}}\" ng-model=\"$select.search\" ng-show=\"$select.open\"> <div ng-class=\"{show : $select.open && $select.items.length > 0}\" class=\"ui-select-dropdown dropdown-menu w-100\"> <div class=\"ui-select-header\"></div> <div class=\"ui-select-choices\"></div> <div class=\"ui-select-footer\"></div> </div> <div class=\"ui-select-no-choice\"></div> </div> ";
